                      ...
                      <div id="filters" style="display:<?php echo $display; ?>;">
                        ...
                        <form class="mt-5" action="" method="get">
                          <div class="row mt-2">
                            ...
                            <div class="form-group col-md-2">
                              <label>Filter By Units No</label>
                            ...
                            <div class="form-group col-md-2">
                              <label>Filter By Units Area</label>
                            ...
                            <div class="form-group col-md-2">
                              <label>Filter By Units Rate</label>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr loading="lazy">
                                ...
                                <td><?php echo $project_block_name . "-" . $projects_floor_name . "-" . $unit_name . " (" . $project_unit_bhk_type . ")"; ?></td>
