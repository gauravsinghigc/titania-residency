...
if (isset($_GET['bookingcontinuetoagent'])) {
  ...
  $_SESSION['parking_status'] = $_GET['parking_status'];
...
$UnitID = $_SESSION['project_unit_id'];
$UnitSQL = "SELECT * FROM project_units where project_units_id='$UnitID'";
                              ...
                              <div id="area">
                                <div class="row">
                                  ...
                                  <div class="from-group col-md-3">
                                    ...
                                    <input type="text" value="<?php echo $UnitRate = FETCH($UnitSQL, "unit_per_price"); ?>" readonly="" class="form-control" placeholder="">
                                  </div>
                                  <div class="from-group col-md-3">
                                    <label>Login Rate <span class="text-danger"></span></label>
                                    <input type="text" value="<?php echo $LoginRate = $_SESSION['unit_rate']; ?>" readonly="" class="form-control" placeholder="">
                                  </div>
                                  <div class="from-group col-md-3">
                                    <label>Last Broker Rate <span class="text-danger" id="msgerr"></span></label>
                                    <input type="text" name="saler-rate" id="salerate" value="<?php echo $BrokerRate = FETCH($UnitSQL, "unit_broker_rate"); ?>" readonly="" class="form-control" placeholder="">
                                  </div>
                                  <div class="from-group col-md-3">
                                    <label>Total Unit Cost <span class="text-danger" id="msgerr"></span></label>
                                    <input type="text" value="<?php echo $_SESSION['unit_cost']; ?>" readonly id='NetUnitCost' class="form-control" placeholder="">
                                  </div>
                                  <div class="from-group col-md-6">
                                    <label>Commission/Rate Per Unit Area</label>
                                    <input type="text" name="commission_rate_area" onload="CalculateCommissionArea()" value='<?php echo (int)$LoginRate - (int)$BrokerRate; ?>' id="commission_rate_area_comm" oninput="CalculateCommissionArea()" class="form-control" placeholder="">
                                  </div>
                                </div>
                              </div>
