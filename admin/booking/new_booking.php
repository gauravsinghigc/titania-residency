                    ...
                    <div class="col-md-12 text-center m-t-2">
                      <div class="steps">
                        ...
                        <a>
                          ...
                          <span class="step-text">Select Units</span>
                        </a>
                        <a>
                          ...
                          ?>
                                ...
                                ?>
                                  <div class="col-md-12 m-b-10">
                                    <div class="row shadow-lg rounded-3 p-1">
                                      ...
                                      <div class="col-md-10">
                                        <h4 class="bold black"><?php echo $Customer->name; ?> <?php echo $Customer->father_name; ?> <small class="text-grey"> | UID00<?php echo $Customer->id; ?></small></h4>
                                        <p>
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="from-group col-md-6">
                                                ...
                                                <select name="user_state" class="form-control" required>
                                                  <?php echo InputOptions(INDIAN_STATES, FETCH($AddSql, "user_state")); ?>
                                                </select>
                                              </div>
                                              <div class="from-group col-md-6">
                                                <label>Pincode</label>
                            ...
                            <div class="col-md-12">
                              <div class="shadow-sm p-2 b-r-1">
                                <h3 class="bold">Search or Add Customers</h3>
              ...
              <form action="../../controller/usercontroller.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="from-group col-md-6">
                    <label>State</label>
                    <select name="user_state" class="form-control" required>
                      <?php echo InputOptions(INDIAN_STATES, ""); ?>
                    </select>
                  </div>
                  <div class="from-group col-md-6">
                    <label>Pincode</label>
                  ...
                  <div class="from-group col-md-6">
                    <label>User Role</label>
                    <select readonly name="user_role_id" class="form-control text-uppercase" required="">
                      <?php
                      $getuserroles = SELECT("SELECT * FROM user_roles where role_id='4'");
                      while ($user_roles = mysqli_fetch_array($getuserroles)) {
                        $role_id = $user_roles['role_id'];
