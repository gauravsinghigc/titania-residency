            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-md-4 col-lg-4 col-4 text-center">
                  ...
                  <h3 class="app-text">Booking Created Successfully!</h3>
                  <a class="btn btn-primary btn-md m-1" target="blank" href="<?php echo DOMAIN; ?>/admin/booking/booking_exports.php?id=<?php echo $_SESSION['booking_id']; ?>"><i class="fa fa-print"></i> Print Receipt <i class="fa fa-angle-right"></i></a>
                  <hr>
                  <a href="docs/welcome-letter.php?id=<?php echo $bookingid; ?>" target="_blank" class="btn btn-md btn-info m-1"><i class="fa fa-print"></i> Welcome Letter</a>
