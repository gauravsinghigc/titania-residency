...
<body style="padding:0.5rem;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif !important;">
  ...
  <section style="width:800px;margin:1% auto; height:1160px;display:block;">
    <br><br><br><br><br><br><br><br><br><br><br><br><br>
    <p style="text-align:justify;">
      <b>E.</b> The Allottee had applied for residential plot in the Project vide application
      no. dated <?php echo DATE_FORMATE2("d M, Y", FETCH($BookingSql, "booking_date")); ?> and has been allotted Plot no. <?php echo FETCH($BookingSql, "unit_name"); ?>
      having area of <?php echo FETCH($BookingSql, "unit_area"); ?> square yard as
      permissible under the applicable law and right in the common areas as per
      provisions of HDRU Act, 1975 (8 of 1975). (hereinafter referred to as the
      “Plot” more particularly described in Schedule A and Schedule “B”, where,
      Zoning of Project and Demarcation of Plot has been mentioned);
      F. The Parties have gone through all the terms and conditions of this
      Agreement and understood the mutual rights and obligations detailed
      herein;
      G. The Parties hereby confirm that they are signing this Agreement with full
      knowledge of all the laws, rules, regulations, notifications, etc., applicable in
      the State and related to the Project;
      H. The Parties, relying on the confirmations, representations and assurances of
      each other, do faithfully abide by all the terms, conditions and stipulations
      ...
      I. In accordance with the terms and conditions of this Agreement and as
      mutually agreed upon by and between the Parties, the Promoter hereby
      agrees to sell and the Allottee(s) hereby agrees to purchase the Plot.
