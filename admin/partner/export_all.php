 ...
 <section style="border-style:groove; border-width:thin;margin: auto; width: 1000px;border: 1px solid rgb(147 78 255);padding: 5px;">
  ...
  <div style="text-align:center;">
   <h3 style="line-height:1;margin-bottom:4px;margin-top:0px;font-size:24px !important;">
    ALL AGENTS<br>
    <small style="color:grey; font-size:19px !important;">AGENT DATA</small>
   </h3>
  </div>
  ...
  <table style="width: 100%;">
   ...
   <tbody>
    ...
    while ($custs = mysqli_fetch_array($GetUSERS)) {
     $id = $custs['id'];
     $getusers = SELECT("SELECT * FROM users, user_address, user_roles where users.company_relation='" . company_id . "' and users.id='$id' and users.user_role_id='3' and users.id=user_address.user_id and users.user_role_id=user_roles.role_id ORDER BY users.id ASC");
