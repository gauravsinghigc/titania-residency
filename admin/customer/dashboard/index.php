            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  $SQL_customerprojects = TOTAL("SELECT * FROM bookings where bookings.customer_id='$CustomerId' GROUP BY project_list_id");
                  if ($SQL_customerprojects == 0) {
                  } else {
                    $SQL_AllBookings = SELECT("SELECT * FROM bookings where bookings.customer_id='$CustomerId' GROUP BY project_list_id");
