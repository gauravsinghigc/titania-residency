...
<body>
  <div id="container" class="navbar-fixed mainnav-fixed mainnav-lg">
    ...
    if (isset($_GET['id'])) {
      ...
      $_SESSION['USER_VIEW_ID_EDIT'] = $_GET['id'];
    } else {
      $ViewCustomerId = $_SESSION['USER_VIEW_ID_EDIT'];
    }
        ...
        <div id="page-content">
          <div class="panel">
            <div class="panel-body">
              <div class="row">
                <div class="col-md-12">
                  <h3 class="mt-0 mb-0"><i class="fa fa-user app-text"></i> Update Profile : <?php echo $C_name ?></h3>
                </div>
                  ...
                  <div class="userWidget-1">
                    ...
                    <div class="panel-body pt-3">
                      <div>
                        <p class='data-list'>
                          <span>
                            <span class='text-grey'>CUSTOMERID</span><br>
                            <span class='text-black'>CUST00<?php echo $ViewCustomerId; ?></span>
                          </span>
                        </p>
                        <p class='data-list'>
                          <span>
