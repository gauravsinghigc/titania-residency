...
<head>
  ...
  <title>All Materials | <?php echo company_name; ?></title>
            ...
            <div class="col-md-12 col-lg-12 col-12">
              <div class="panel square">
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="m-t-5 m-b-0"><i class="fa fa-truck app-text"></i> All Materials</h3>
                      <a href="index.php" class="btn btn-md btn-default m-t-5"><i class='fa fa-angle-left'></i> Back to Dashboard</a>
                      <a href="all-vendors.php" class="btn btn-md btn-default m-t-5"><i class='fa fa-angle-left'></i> Go to All Vendors</a>
                      <a href="add-record.php" class="btn btn-md pull-right btn-danger">Add New Record</a>
                    </div>
                  </div>
