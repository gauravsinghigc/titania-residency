...
!(function () {
 ...
 var Xe = function (e, t) {
  ...
  Ge = function (e, t) {
   return (
    "" === (n = t) || (e.length >= n.length && e.substr(0, 0 + n.length) === n)
   );
   var n;
  },
  Je = Oe(/^\s+|\s+$/g),
  ...
  ot = $e,
  it =
   (J("Edge"), J("Chrome"), J("IE"), J("Opera"), J(nt), J("Safari"), "Windows"),
  at = "Android",
  ut = "Solaris",
  st = "FreeBSD",
  ct = "ChromeOS",
  ...
  Et = {
   ...
   create: function (e, t, n) {
    ...
    if (!c[s]) {
     if ("static" === e[2])
      return (
       (c[s] = t), void (this.onCreate && this.onCreate(e[2], e[3], c[s]))
      );
 ...
 function Ur(e) {
  ...
  return (
   !!jn(t) &&
   (t.data.charAt(e.offset() - 1) === Co || (e.isAtEnd() && Lr(t.nextSibling)))
  );
 }
 function zr(e) {
 ...
 var co = Tr(["h1", "h2", "h3", "h4", "h5", "h6"]),
  ...
  Lo = function (e) {
   return (
    !1 === (zn((t = e)) && "true" === t.getAttribute("unselectable")) && Ao(e)
   );
   var t;
  },
  Io = /^[ \t\r\n]*$/,
 ...
 function ua() {
  ...
  function r(e, t) {
   return (
    n.push(e + " ") > li.cacheLength && delete r[n.shift()], (r[e + " "] = t)
   );
  }
  return r;
 }
       ...
       for (
        var o,
         ...
         f = [
          function (e, t, n) {
           var r =
            (!a && (n || t !== hi)) || ((o = t).nodeType ? c : l)(e, t, n);
           return (o = null), r;
          },
         ];
        s < i;
   ...
   var o = [],
    ...
    d = function (r, o, i, a, e) {
     ...
     l[r] ||
      (0 !==
       (t =
        "string" == typeof o ? o : o.prefix + o.resource + o.suffix).indexOf(
        "/"
       ) &&
       -1 === t.indexOf("://") &&
       (t = su.baseURL + "/" + t),
 ...
 function Ru(e, t) {
  ...
  return (
   e.bottom - n < t.top || (!(e.top > t.bottom) && Au(t.top - e.bottom, e, t))
  );
 }
 function Du(e, t) {
  return (
 ...
 function Ts(e) {
  ...
  return (
   !1 !== t && !xt.iOS && (X(t) ? t : "table,img,figure.image,div,video,iframe")
  );
 }
 function Os(e) {
 ...
 function tl(e, t) {
  return (
   Qc(t) && (t = t.nodeName), !!e.schema.getTextBlockElements()[t.toLowerCase()]
  );
 }
 function nl(e, t, n) {
 ...
 function El(n, e, u) {
  function s(e) {
   ...
   var n = e[e.length - 1];
   return (
    0 === a && 0 < e.length && n === l && jn(n) && e.splice(e.length - 1, 1), e
   );
  }
  function c(e, t, n) {
 ...
 var zl,
  ...
  Yl = function (e, t, n) {
   ...
   if (t.isEqual(as.after(n)) && n.lastChild) {
    if (
     ((i = as.after(n.lastChild)), e < 0 && Kl(n.lastChild) && $l(n.lastChild))
    )
          ...
          g.replace(B, function (e, t, n, r, o) {
           return (
            (function (e, t, n, r, o) {
             ...
             if (
              ((n = Hd(
               (t = t.toLowerCase()) in I ? t : N(n || r || o || ""),
               s
              )),
              M &&
               !l &&
               0 ==
                (0 === (i = t).indexOf("data-") || 0 === i.indexOf("aria-")))
             ) {
              var a = p[t];
              if (!a && h) {
 ...
 function Sg(e, t, n) {
  ...
  if (m.isDefaultPrevented())
   ...
   if (!0 === n.paste && bg(e.schema, B) && Cg(s, I))
    return (
     (g = wg(f, s, u.getRng(), B)), u.setRng(g), void e.fire("SetContent", m)
    );
   if (
    ((function () {
     ...
     if (
      ...
      if (
       ...
       if (
        ...
        return (
         b.removeAttribute(t), void u.setStyle(b, "list-style-type", "none")
        );
      ...
      if ("text" === i.format)
       return (
        ...
        ve
         ...
         .map(function (e) {
          var t = ve.from(
            m.dom.getParent(e.commonAncestorContainer, m.dom.isBlock)
           ),
           n = m.getBody(),
           r = t
            .map(function (e) {
      ...
      c = function (e) {
       ...
       if (ll(A) && A.wrapper && hp(S, e, E, N)) s = null;
        ...
        (dl(A) && x.isBlock(e))
         ...
         : (s ||
            ((s = x.clone(m, !1)), e.parentNode.insertBefore(s, e), w.push(s)),
           s.appendChild(e));
       }
      };
     Y(e, c);
       ...
       if (A.isValidChild(k.name, b.toLowerCase())) {
        for (; t; ) {
         ...
         (1 === t.type &&
          ...
          ? (n ||
             ((n = d(b, 1)).attr(_.forced_root_block_attrs), k.insert(n, t)),
            n.append(t))
          : (e(n), (n = null)),
          (t = r);
        }
 ...
 var sv,
  ...
  fv = function (e, t) {
   return (
    e && e.firstChild && e.firstChild === e.lastChild && e.firstChild.name === t
   );
  },
  dv = Et.makeMap,
  mv = Et.each,
 ...
 function Jv(c) {
  ...
  return (
   ...
   }),
   {
    ...
    match: function (e, t, n, r) {
     return (
      (o = e), (i = t), (a = n), (u = r), hh(c).formatter.match(o, i, a, u)
     );
     var o, i, a, u;
    },
    closest: function (e) {
    ...
    return (
     ...
     (!1 === c && tp(f)
      ...
      return e.fold(
       function (e) {
        return (
         o._selectionOverrides.hideFakeCaret(), Ym(o, i, Nt.fromDom(e)), !0
        );
       },
       ((r = i = g),
       function (e) {
 ...
 function rC(e, t) {
  return (
   e.nodeName === t || (e.previousSibling && e.previousSibling.nodeName === t)
  );
 }
 function oC(e, t) {
  return (
  ...
  function n(u) {
   i.on(function (e) {
    ...
    e.dragging &&
     ((o =
      3 ===
      (a = (r = s).selection.getSel().getRangeAt(0).startContainer).nodeType
       ? a.parentNode
       : a) === (i = e.element) ||
      r.dom.isChildOf(o, i) ||
      D1(o) ||
  ...
  return (
   ...
   (e.iframeHTML = (function (e) {
    ...
    return (
     ws(e) &&
      (t +=
       '<meta http-equiv="Content-Security-Policy" content="' + ws(e) + '" />'),
     t +
      ('</head><body id="' +
       n +
   ...
   (K1.prototype.setupCommands = function (u) {
    ...
    this.addCommands({
     ...
     selectAll: function () {
      ...
      t &&
       ((e = u.dom.createRng()).selectNodeContents(t), u.selection.setRng(e));
     },
      ...
      ? t.getElement() &&
        ...
        (i = t.getElement().form || U1.getParent(e, "form")) &&
         ...
         !t.getParam("submit_patch") ||
          ...
          (i.submit = function () {
           return (
            t.editorManager.triggerSave(), t.setDirty(!1), i._mceOldSubmit(i)
           );
          }))),
     ...
     Fx[e.id] === e ||
      ...
      Tx ||
       ((Tx = function (e) {
        ...
        if (t.returnValue)
         return (
          e.preventDefault(), (e.returnValue = t.returnValue), t.returnValue
         );
       }),
  ...
  dw =
   ...
   (mw.prototype.send = function (e) {
    ...
    (o.success = function (e, t) {
     (e = void 0 === (e = sw.parse(e)) ? { error: "JSON Parse error." } : e)
      .error
