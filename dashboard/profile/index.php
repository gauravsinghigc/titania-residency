...
$_SESSION['RUNNING_URL'] = "dashboard/profile";
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  <div id="container" class="navbar-fixed mainnav-fixed mainnav-lg">
    ...
    <div class="boxed">
      <!--CONTENT CONTAINER-->
      <!--===================================================-->
      <div id="content-container" class="pl-0">
        <!--Page content-->
        <!--===================================================-->
        <div id="page-content" class="flex-center">
          <div class="row w-60">
            <div class="col-md-12">
              <h3 class="app-bg p-2r"><a href="../index.php" class="btn btn-sm btn-primary"><i class="fa fa-angle-left"></i></a> Profile</h4>
            </div>
                  ...
                  <div class="tab-base">
                    ...
                    <div class="tab-content">
                      ...
                      <div id="profile" class="tab-pane fade active in">
                        ...
                        <input type='text' name="access_url" value="../dashboard/profile/" hidden="">
