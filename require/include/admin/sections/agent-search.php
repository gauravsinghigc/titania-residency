         ...
         <div class="col-md-12 m-b-15">
           <div class="row shadow-lg rounded-3 p-1 fs-12 p-b-10">
             ...
             <div class="col-md-10">
                 ...
                 <span>
                   <b>
                     <?php $user_role_id = $Customer->user_role_id;
                      echo FETCH("select * from user_roles where role_id='$user_role_id'", "role_name"); ?> | </b>
               ...
               <a href="<?php echo RUNNING_URL; ?>&partner_id=<?php echo $Customer->id; ?>" class="btn btn-md <?php echo $selected; ?>"><?php echo $text; ?></a>
             </div>
             <br>
           </div>
         </div>
