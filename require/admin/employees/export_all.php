...
<head>
 ...
 <title>Export All Employees</title>
</head>
 ...
 <section style="border-style:groove; border-width:thin;margin: auto; width: 950px;border: 1px solid rgb(147 78 255);padding: 5px;">
  ...
  <div style="text-align:center;">
   <h3 style="line-height:1;margin-bottom:4px;margin-top:0px;">
    ALL EMPLOYEES<br>
    <small style="color:grey; font-size:11px;">EMPLOYEE DATA</small>
   </h3>
  </div>
  ...
  <table style="width: 100%;font-size:10px;">
   ...
   <tbody>
    ...
    while ($custs = mysqli_fetch_array($GetUSERS)) {
     $id = $custs['id'];
     $getusers = SELECT("SELECT * FROM users, user_address, user_roles where users.company_relation='" . company_id . "' and users.id='$id' and users.user_role_id='5' and users.id=user_address.user_id and users.user_role_id=user_roles.role_id ORDER BY users.id ASC");
  ...
  <p style="color:grey; font-size:10px;text-align:center;"><b>Exported On:</b> <?php echo date("D d M, Y"); ?> by (UID : <?php echo LOGIN_UserId; ?>) <?php echo LOGIN_UserFullName; ?>, <?php echo $email; ?>, <?php echo LOGIN_UserPhoneNumber; ?> | <b>UserType :</b> <?php echo LOGIN_UserRoleName; ?></p>
