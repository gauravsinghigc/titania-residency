  ...
  <section style="padding:0.5rem;margin:2% auto;display:block;">
      ...
      <h2 style="text-align:center;margin-top: -1.5rem;margin-bottom:-0.2rem !important;">Reminder Letter <br>
        ...
        <p style="display:flex;justify-content:space-between;font-size:14px;">
          ...
          <span style="text-align:right;">
            <span><b>Reminde Date :</b> <?php echo DATE_FORMATE2("d M, Y", FETCH($DMDSql, "PayReqDate")); ?></span><BR>
    ...
    <div style="font-size:14px !important;">
      ...
      <p style="margin-top:0px !important;"><br><br>
        <b>Subject :</b> Payment request against your Allotment of Plot No. <b><?php echo FETCH($BookingSql, "unit_name"); ?></b>, having Area: <b><?php echo FETCH($BookingSql, "unit_area"); ?></b>
        <br><br><br>
          ...
          <tbody>
            <tr>
              ...
              <td>Till Date of this
                Demand Letter</td>
              <td><?php echo Price($net = $net_paid_amount2, "", "Rs."); ?></td>
            </tr>
            <tr>
              <td>2</td>
              <td>Current
                ...
                (*Current
                Demand)</td>
              <td><?php echo FETCH($DMDSql, "PayRequestDescriptions"); ?></td>
              <td><?php echo Price($current = FETCH($DMDSql, "PayRequestingAmount") + (int)$net, "", "Rs."); ?></td>
            </tr>
            <tr>
              <td>3</td>
              <td>Due as on
  ...
  <section style="height:100%;padding:0.5rem;margin:2% auto;display:block;">
    ...
    <div style="font-size:14px !important;">
      ...
      <p>
        ...
        <b>8. <?php echo FETCH($DMDSql, "PayReqSendDescsriptions"); ?></b><br>
      </p>
